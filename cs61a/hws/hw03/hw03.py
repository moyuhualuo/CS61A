...
def count_coins(total):
    ...
    def helper(total, small_coin):
        ...
        elif small_coin == None: return 0
        without_coin = helper(total, next_larger_coin(small_coin)) 
